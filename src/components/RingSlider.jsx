...
export default function RingSlider({ images }) {
  ...
  console.log('RingSlider rendering with', images?.length, 'images');

  // Safety check for images
  if (!images || !Array.isArray(images) || images.length === 0) {
    console.error('RingSlider: No images provided');
    return (
      <div className="relative w-full h-[520px] flex items-center justify-center overflow-hidden bg-red-100">
        <p className="text-red-600">No images provided to RingSlider</p>
      </div>
    );
  }
